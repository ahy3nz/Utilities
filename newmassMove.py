...
if options.toRahman:
    ...
    subprocess.Popen('scp -r {}/{} $EDISON:/scratch2/scratchdirs/ahy3nz/Trajectories'.format(os.getcwd(), tar_ball), shell= True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
